...
public class WordDao extends AbstractDao<Word, Long> {
	...
	public static class Properties {
		...
		public final static Property Word = new Property(1, String.class,
				"word", false, "WORD");
		public final static Property UrlVideo = new Property(2, String.class,
				"urlVideo", false, "URL_VIDEO");
	};
	...
	public static WordDao create() {
		WordDao wordDao = Database.session().getWordDao();
		return wordDao;
	}

	public static Word findByName(String name) {
		Word word = WordDao.create().queryBuilder()
				.where(Properties.Word.eq(name)).unique();
		return word;
	}
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'WORD' (" + //
				...
				"'URL_VIDEO' TEXT NOT NULL );"); // 2: urlVideo
	}
	...
	protected void bindValues(SQLiteStatement stmt, Word entity) {
		...
		stmt.bindString(3, entity.getUrlVideo());
	}
	...
	public Word readEntity(Cursor cursor, int offset) {
		Word entity = new Word( //
				...
				cursor.getString(offset + 2) // urlVideo
		);
		return entity;
	}
	...
	public void readEntity(Cursor cursor, Word entity, int offset) {
		...
		entity.setUrlVideo(cursor.getString(offset + 2));
	}
