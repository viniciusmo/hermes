...
public class ItemBoardDao extends AbstractDao<ItemBoard, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property PathSound = new Property(2, String.class, "pathSound", false, "PATH_SOUND");
        public final static Property PathImage = new Property(3, String.class, "pathImage", false, "PATH_IMAGE");
    };
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ITEM_BOARD'";
        db.execSQL(sql);
    }
    ...
    /** Internal query to resolve the "itemBoardList" to-many relationship of Board. */
